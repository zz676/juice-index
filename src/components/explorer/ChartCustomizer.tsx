            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                {activeSection === "chart" && (
                    <div className="space-y-2">
                        ...
                        {/* Layout */}
                        <div className="border-t border-slate-100 pt-2 space-y-1.5">
                            <label className="text-xs font-semibold text-primary uppercase tracking-wide bg-primary/[0.13] px-1.5 py-0.5 rounded text-center block">Layout</label>
                            <NumberInput label="Bar Width" value={config.barWidth} onChange={(v) => update({ barWidth: v })} min={1} max={100} />
                            <div>
                                <label className="text-xs font-semibold text-primary uppercase tracking-wide bg-primary/[0.13] px-1.5 py-0.5 rounded text-center mb-1 block">Padding</label>
                        ...
                        {/* Axes */}
                        <div className="border-t border-slate-100 pt-2 space-y-1.5">
                            <label className="text-xs font-semibold text-primary uppercase tracking-wide bg-primary/[0.13] px-1.5 py-0.5 rounded text-center block">Axes</label>
                            {hasMultipleColumns && (
                                <>
                                    <div className="flex items-center justify-between gap-2">
                            ...
                            <div className="flex items-center justify-between gap-2">
                                ...
                                <div className="flex items-center gap-1.5">
                                    <select
                                        ...
                                        className="h-7 w-32 rounded border border-slate-200 bg-white px-2 text-xs text-slate-700 focus:outline-none focus:ring-1 focus:ring-primary"
                                    >
                                        {["Inter", "Arial", "Helvetica", "Georgia", "Times New Roman", "Courier New", "Verdana", "Trebuchet MS"].map((f) => (
                                            <option key={f} value={f} style={{ fontFamily: f }}>{f}</option>
                                        ))}
                ...
                {activeSection === "saved" && (
                    <div className="space-y-5">
                        {/* Saved styles picker */}
                        <div>
                            <label className="text-xs font-semibold text-primary uppercase tracking-wide bg-primary/[0.13] px-1.5 py-0.5 rounded text-center mb-2 block">
                                Saved Styles
                            </label>
